...
type FightActionId = Nominal<"FightActionId">;

type AbilityTypeId = Nominal<"AbilityTypeId">;
type SkillCategoryId = Nominal<"SkillCategoryId">;
type SkillTypeId = Nominal<"SkillTypeId">;
type SkillToolTypeId = Nominal<"SkillToolTypeId">;
type TraitCategoryId = Nominal<"TraitCategoryId">;
type TraitTypeId = Nominal<"TraitTypeId">;
type ResourceTypeId = Nominal<"ResourceTypeId">;
type PracticeId = Nominal<"PracticeId">;
type QuestionId = Nominal<"QuestionId">;
...
type UnitModifierId = Nominal<"UnitModifierId">; 
