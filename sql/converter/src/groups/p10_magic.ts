...
export function processMagic(): Processed {
	...
	return {
		...
		data: [
			...
			arrayToSQL("dat", "SpellElementFacets", '"Id", "Name", "Obstacle", "Actions", "Resource"', datSpellElementFacets),
			arrayToSQL("dat", "SpellImpetusFacets", '"Id", "Name", "Obstacle", "Actions", "Resource"', datSpellImpetusFacets)
		]
	};
}
