import { SkillCategories } from "../raw_data_bwgr/skills/_skills";
...
function processSubskills(skillRefs: Reference[]): Processed {
	...
	const subskills = arrayToSQL("bwgr", "SkillSubskills", '"SkillId", "SubskillId"', datSubskills);
...
export function processSkills(refs: References): Processed {
	...
	return {
		...
		data: [
			arrayToSQL("bwgr", "Skills", '"Id", "Name", "StockId", "CategoryId", "TypeId", "IsMagical", "IsTraining", "DontList", "Root1Id", "Root2Id", "Description", "ToolTypeId", "ToolDescription", "RestrictionOnlyStockId", "RestrictionWhenBurning", "RestrictionAbilityId"', datSkills),
			arrayToSQL("bwgr", "RulesetSkills", '"SkillId", "RulesetId"', datRulesetSkills),
