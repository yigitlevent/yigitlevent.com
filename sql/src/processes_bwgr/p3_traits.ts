import { TraitCategories } from "../raw_data_bwgr/traits/_traits";
...
export function processTraits(refs: References): Processed {
	...
	return {
		...
		data: [
			arrayToSQL("bwgr", "Traits", '"Id", "Name", "StockId", "CategoryId", "TypeId", "Cost", "Description"', datTraits),
			arrayToSQL("bwgr", "RulesetTraits", '"TraitId", "RulesetId"', datRulesetTraits)
		]
	};
}
