import { Stats } from "../raw_data_bwgr/stats";
import { Attributes } from "../raw_data_bwgr/attributes";
...
export function processAbilities(refs: References): Processed {
	...
	return {
		...
		data: [
			arrayToSQL("bwgr", "Abilities", '"Id", "Name", "AbilityTypeId", "HasShades", "Cycle", "Routine", "Difficult", "Challenging", "RequiredTraitId"', datAbilities)
		]
	};
}
