import { RangeAndCoverActions } from "../raw_data_bwgr/rangeAndCover";
...
export function processRangeAndCover(refs: References): Processed {
	...
	return {
		...
		data: [
			arrayToSQL("bwgr", "RangeAndCoverActionGroups", '"Id", "Name"', datRaCActionGroups),
			arrayToSQL("bwgr", "RangeAndCoverActions", '"Id", "Name", "GroupId", "Modifier", "UseFoRKs", "UseWeaponRangeAdvantage", "UsePositionAdvantage", "UseStrideAdvantage", "IsOpenEnded", "Effect", "SpecialRestriction", "SpecialAction", "However"', datRaCActions),
			arrayToSQL("bwgr", "RangeAndCoverActionResolutions", '"Id", "ActionId", "OpposingActionId", "ResolutionTypeId", "IsAgainstSkill", "Obstacle", "SkillId", "AbilityId", "OpposingSkillId", "OpposingAbilityId", "OpposingModifier"', datRaCActionResolutions)
		]
	};
}
