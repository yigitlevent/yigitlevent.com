import { FightActions } from "../raw_data_bwgr/fight";
...
export function processFight(refs: References): Processed {
	...
	return {
		...
		data: [
			arrayToSQL("bwgr", "FightActionGroups", '"Id", "Name"', datFightActionGroups),
			arrayToSQL("bwgr", "FightActions", '"Id", "Name", "GroupId", "ActionCost", "TestExtra", "Restrictions", "Effect", "Special", "CountsAsNoAction"', datFightActions),
			arrayToSQL("bwgr", "FightActionTests", '"Id", "ActionId", "SkillId", "AbilityId"', datFightActionTests),
			arrayToSQL("bwgr", "FightActionResolutions", '"Id", "ActionId", "OpposingActionId", "ResolutionTypeId", "IsAgainstSkill", "Obstacle", "SkillId", "AbilityId", "OpposingSkillId", "OpposingAbilityId", "OpposingModifier"', datFightActionResolutions)
		]
	};
}
