		...
		(set, get) => ({
			...
			loadHexmap: (mapId?: HmHexmapId) => {
				...
				const hexmapResponse: HmHexmapResponse = {
					...
					hexes: [
						{ id: "-2,-1.5" as HmHexId, name: "", position: { "x": -2, "y": -1.5 }, type: { biomeId: 1 as HmBiomeId, terrainId: 2 as HmTerrainId } },
						{ id: "-2,-0.5" as HmHexId, name: "", position: { "x": -2, "y": -0.5 }, type: { biomeId: 1 as HmBiomeId, terrainId: 2 as HmTerrainId } },
						{ id: "-2,0.5" as HmHexId, name: "", position: { "x": -2, "y": 0.5 }, type: { biomeId: 1 as HmBiomeId, terrainId: 1 as HmTerrainId } },
						{ id: "-1,-1" as HmHexId, name: "", position: { "x": -1, "y": -1 }, type: { biomeId: 1 as HmBiomeId, terrainId: 2 as HmTerrainId } },
						{ id: "-1,0" as HmHexId, name: "Hex 6", position: { "x": -1, "y": 0 }, type: { biomeId: 1 as HmBiomeId, terrainId: 1 as HmTerrainId } },
						{ id: "-1,1" as HmHexId, name: "Hex 7", position: { "x": -1, "y": 1 }, type: { biomeId: 1 as HmBiomeId, terrainId: 1 as HmTerrainId } },
						{ id: "0,-0.5" as HmHexId, name: "Hex 3", position: { "x": 0, "y": -0.5 }, type: { biomeId: 1 as HmBiomeId, terrainId: 3 as HmTerrainId } },
						{ id: "0,0.5" as HmHexId, name: "Hex 1", position: { "x": 0, "y": 0.5 }, type: { biomeId: 1 as HmBiomeId, terrainId: 0 as HmTerrainId } },
						{ id: "0,1.5" as HmHexId, name: "Hex 2", position: { "x": 0, "y": 1.5 }, type: { biomeId: 1 as HmBiomeId, terrainId: 0 as HmTerrainId } },
						{ id: "1,-1" as HmHexId, name: "", position: { "x": 1, "y": -1 }, type: { biomeId: 1 as HmBiomeId, terrainId: 3 as HmTerrainId } },
						{ id: "1,0" as HmHexId, name: "Hex 4", position: { "x": 1, "y": 0 }, type: { biomeId: 1 as HmBiomeId, terrainId: 3 as HmTerrainId } },
