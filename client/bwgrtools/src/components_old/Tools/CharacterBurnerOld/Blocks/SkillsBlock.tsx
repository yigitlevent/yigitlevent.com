...
import { BlockSkillPopover } from "../../CharacterBurner/BlockText";
import { GeneralSkillModal } from "../Modals/GeneralSkillModal";


function MandatorySkillsBlock() {
	const { totals, getSkillOpenness, getSkillShade, getSkillExponent, changeSkillExponent } = useCharacterBurnerStoreOld();
...
function LifepathSkillsBlock() {
	const { totals, getSkillOpenness, getSkillShade, getSkillExponent, openSkill, changeSkillExponent } = useCharacterBurnerStoreOld();
...
function GeneralSkillsBlock() {
	const { totals, getSkillOpenness, getSkillShade, getSkillExponent, openSkill, changeSkillExponent, removeSkill } = useCharacterBurnerStoreOld();
...
export function SkillsBlock() {
	const { totals, getSkillRemainings } = useCharacterBurnerStoreOld();
