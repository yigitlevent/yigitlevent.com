...
function CommonTraitsBlock() {
	const { totals } = useCharacterBurnerStoreOld();
...
function MandatoryTraitsBlock() {
	const { totals, getTraitOpenness } = useCharacterBurnerStoreOld();
...
function LifepathTraitsBlock() {
	const { totals, openTrait, getTraitOpenness, getTraitRemainings } = useCharacterBurnerStoreOld();
...
function GeneralTraitsBlock() {
	const { totals, openTrait, removeTrait, getTraitOpenness, getTraitRemainings } = useCharacterBurnerStoreOld();
...
function BrutalLifeTraitsBlock() {
	const { stockSpecific } = useCharacterBurnerStoreOld();
...
export function TraitsBlock() {
	const { totals, stockSpecific, getTraitRemainings } = useCharacterBurnerStoreOld();
