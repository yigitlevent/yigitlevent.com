...
export function StatsBlock() {
	const { totals, changeStatShade, changeStatExponent, getStatRemainings, getMentalPointsTotal, getPhysicalPointsTotal, getStatShade, getStatExponent } = useCharacterBurnerStoreOld();
