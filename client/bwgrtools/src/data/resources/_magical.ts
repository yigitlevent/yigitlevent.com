...
export const SorcerySpells: Resource[] = [
	...
	},
	{
		...
		magical: {
			...
			element: ["Fire", "Air"],
			duration: "Sustained",
			areaOfEffect: "Measured Area",
			areaOfEffectMeasuredUnit: "10s of paces",
			impetus: ["Create", "Tax"],
			obstacle: 5,
			actions: 16
		}
	...
	},
	{
		...
		magical: {
			...
			duration: "Instantaneous",
			areaOfEffect: "Measured Area",
			areaOfEffectMeasuredUnit: "paces",
			impetus: ["Destroy"],
			obstacle: 3,
			obstacleCaret: true,
			actions: 3
	...
	},
	{
		...
		magical: {
			...
			duration: "Instantaneous",
			areaOfEffect: "Measured Area",
			areaOfEffectMeasuredUnit: "100s of paces",
			impetus: ["Control"],
			obstacle: 4,
			obstacleCaret: true,
			actions: 256
...
export const RitualsOfNightRituals: Resource[] = [
	...
	},
	{
		...
		magical: {
			...
			duration: "Sustained",
			areaOfEffect: "Measured Area",
			areaOfEffectMeasuredUnit: "miles",
			impetus: ["Influence"],
			obstacle: 5,
			actions: 8
		}
