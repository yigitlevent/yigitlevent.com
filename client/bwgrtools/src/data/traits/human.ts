...
export const HumanLifepath: TraitCategory = {
	...
	traits: [
		...
		},
		{
			allowed: ["bs"],
			cost: 0,
			description: "This defiler has left a long list of enemies behind him. He receives either a hateful minor relationship or a 1D infamous reputation for free.",
		...
		},
		{
			allowed: ["bs"],
			cost: 0,
			description: "The smell and texture of the dead, powdery ash they create clings to defilers no matter how they wash or perfume themselves.",
			name: "Ashen Stink",
			stock: "Human",
			type: "Character"
		},
		...
		},
		{
			allowed: ["bs"],
			cost: 0,
			description: "The public spectacle of gladiator bouts is a common feature of all the cities of Athas. Gladiators who develop a bit of panache and popular appeal are instantly recognized; this trait gives the character a free +1D reputation, but also adds +2 Ob to Inconspicuous within his native city.",
			name: "Popular Hero",
			stock: "Human",
			type: "Die"
		},
		{
			allowed: ["bs"],
			cost: 0,
			description: "The tribal shaman is accorded great respect by his people; he is the keeper of their lore and an intermediary with the afterlife. This trait grants the shaman a free 1D reputation within his tribe.",
			name: "Revered",
			stock: "Human",
			type: "Die"
		},
		...
		},
		{
			allowed: ["bs"],
			cost: 0,
			description: "He speaks in riddles, circles, or just plain nonsense. +1D to Obfuscate and Avoid the Topic in a Duel of Wits.",
			name: "Maddening",
			stock: "Human",
			type: "Die"
		}
