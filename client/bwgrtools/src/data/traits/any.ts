...
export const AnyCallon: TraitCategory = {
	...
	traits: [
		...
		},
		{
			allowed: ["bs"],
			cost: 2,
			description: "Old gods. Spirits. Ancestors. Pray to them all you like; they will not answer. No matter how you scream and cry, no matter how great your need. Yet, occasionally, the faith itself is enough.<br>This trait is a call-on for Steel when faced with fear, pain, or hardship. Additionally, whenever the character fails a Steel test, he has an additional option: Kneel and Pray (functionally identical to Fall Prone And Beg For Mercy).",
			name: "Empty Faith",
			stock: "Any",
			type: "Call-on and Die"
		}
...
export const AnyDie: TraitCategory = {
	...
	traits: [
		...
		},
		{
			allowed: ["bs"],
			cost: 4,
			description: "Whether or not this character bears the rank and privileges of a templar, he has been granted special favor by his Sorcerer-King, and may draw upon the king's vast power to perform \"miracles\". See the King's Favor rules above.",
			name: "Favored",
			stock: "Any",
			type: "Die"
		},
		...
		},
		{
			allowed: ["bs"],
			cost: 8,
			description: "With this technique, sorcerer may use other life forms other than plants as a fuel for their sorceries.",
			name: "Darkest Power",
			stock: "Any",
			type: "Die"
		}
...
export const AnyMonstrous: TraitCategory = {
	allowed: ["bwc"],
	name: "Any Monstrous",
	traits: [
		{
