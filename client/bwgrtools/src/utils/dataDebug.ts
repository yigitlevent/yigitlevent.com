...
function CheckStock(stockName: string, stockPath: string, errorPath: string): Error | undefined {
...
function CheckSetting(stockName: string, settingName: string, stockPath: string, errorPath: string): Error | undefined {
	stockName = FixAsterisk(stockName);
...
function CheckLifepath(stockName: string, settingName: string, lifepathName: string, stockPath: string, errorPath: string): Error | undefined {
	stockName = FixAsterisk(stockName);
	settingName = FixAsterisk(settingName);
...
function CheckSkillCategory(skillCategory: string, skillPath: string, errorPath: string): Error | undefined {
...
function CheckSkillName(skillCategory: string, skillName: string, skillPath: string, errorPath: string): Error | undefined {
	skillCategory = FixAsterisk(skillCategory);
...
function CheckTraitCategory(traitCategory: string, traitPath: string, errorPath: string): Error | undefined {
...
function CheckTraitName(traitCategory: string, traitName: string, traitPath: string, errorPath: string): Error | undefined {
	traitCategory = FixAsterisk(traitCategory);
...
function CheckLeads(lifepath: Lifepath, errorPath: string): [Error[], Warning[]] {
...
function CheckSkills(lifepath: Lifepath, errorPath: string): [Error[], Warning[]] {
	const errors: { path: string; type: string; error: string; }[] = [];
	const warnings: { path: string; type: string; warning: string; }[] = [];
...
function CheckTraits(lifepath: Lifepath, errorPath: string): [Error[], Warning[]] {
	const errors: { path: string; type: string; error: string; }[] = [];
	const warnings: { path: string; type: string; warning: string; }[] = [];
...
function CheckRequirements(lifepath: Lifepath, errorPath: string): [Error[], Warning[]] {
	const errors: { path: string; type: string; error: string; }[] = [];
	const warnings: { path: string; type: string; warning: string; }[] = [];
