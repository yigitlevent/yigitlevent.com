...
export type BwgrSkillId = Nominal<number, "BwgrSkillId">;
export type BwgrSkillCategoryId = Nominal<number, "BwgrSkillCategoryId">;
export type BwgrSkillTypeId = Nominal<number, "BwgrSkillTypeId">;
export type BwgrSkillToolTypeId = Nominal<number, "BwgrSkillToolTypeId">;

export interface BwgrSkillDBO {
